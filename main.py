...
# إخفاء التحذيرات لضمان استقرار التطبيق
...
def main(page: ft.Page):
    ...
    answers = []
    # نستخدم قائمة تحتوي عنصر واحد لتسهيل التعديل من داخل الدوال
    state = {"index": 0}
    ...
    def build_welcome_view():
        return ft.Column(
            [
                ...
                # تصحيح: استخدام ElevatedButton بدلاً من Button
                ft.ElevatedButton(
                    text="ابدأ الفحص الآن",
                    width=200, height=50,
    ...
    def build_question_view():
        ...
        return ft.Column(
            [
                ...
                ft.ProgressBar(width=300, value=current_idx/len(questions), color="blue"),
